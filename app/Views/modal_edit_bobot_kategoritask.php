<div class="modal fade" id="modaledit_bobot_kategori_task" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
   <div class="modal-dialog">
      <div class="modal-content">
         <form action="" method="POST" id="formBobotKategoritask_e">
            <div class="modal-header bg-warning">
               <h5 class="modal-title" style="font-weight: bold; color: white;">Edit bobot Kategori Task</h5>
               <button type="button" class="btn-close tombol-tutup-bobot-kategori-task_e" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
               <!--Kalau ada error-->
               <div class="alert alert-danger error-bobot-kategori-task_e" role="alert" style="display: none"> <!--display none agar tidak ditampilkan saat pertama kali dan ditampilkan jika dipicu oleh hide() dan show() dari script jquery-->
               </div>
               <!--Kalau sukses-->
               <div class="alert alert-success sukses-bobot-kategori-task_e" role="alert" style="display: none">
               </div>
               <div class="row mb-3">
                  <div class="col-sm-6">
