<div class="modal fade" id="modaledit_bobot_kategori_task" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
   <div class="modal-dialog">
      <div class="modal-content">
         <form action="/bobot_kategori_task/update_bobot_kategori_task" method="POST" id="formBobotKategoritask_e">
               ...
               <div class="row mb-3">
                  <div class="col-sm-6">
                     ...
                     <?php foreach ($kategori_task as $kt) : ?>
                        <input type="text" style="background-color:gainsboro" class="form-control mb-2" name="kategori_task_bobot_kategori_task_e[<?= $kt['id_kategori_task'] ?>]" id="kategori_task_bobot_kategori_task_e_<?= $kt['id_kategori_task'] ?>" value="<?= $kt['nama_kategori_task'] ?>" readonly>
            ...
            <div class="modal-footer">
               <button type="button" class="btn btn-secondary tombol-tutup-bobot-kategori-task_e" data-bs-dismiss="modal" onclick="resetForm_bobot_kategori_task()">Tutup</button>
