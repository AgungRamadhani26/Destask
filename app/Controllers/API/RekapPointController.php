...
class RekapPointController extends ResourceController {
    ...
    protected $modelTask = 'App\Models\API\TaskModel';
    protected $modelKategoriTask = 'App\Models\API\KategoriTaskModel';
    protected $modelBobotKategoriTask = 'App\Models\API\BobotKategoriTaskModel';
    ...
    public function rekappoint($idUser) {
        ...
        foreach ($tasks as $taskItem) {
            ...
            if (($taskItem['tgl_selesai'] != null && strtotime($taskItem['tgl_selesai']) <= strtotime($taskItem['tgl_planing']))) {
                ...
                $taskItem['bobot_point'] = $bobotKategoriTask['bobot_poin']; // Add bobot_poin to taskItem
                $result[] = $taskItem;
            }
        }
